...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2022 a las 17:54:50
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `stpInsertarCatTiff` (`tTiffv` VARCHAR(30), `tNombrev` VARCHAR(100), `tNombreCortov` VARCHAR(50), `tRFCv` VARCHAR(30), `ecodEstadov` INT(50), `ecodCiudadv` INT(50), `loginEcodUsuarios` VARCHAR(50), `ecodTiffv` INT(50), `ecodEstatusv` INT(16))   BEGIN
DECLARE existe int;
SET existe = (SELECT count(*) FROM cattiff WHERE ecodTif = ecodTiffv);
IF existe = 0 
THEN
	
insert into cattiff(`tTif`,`tNombre`,`tNombreCorto`,`tRFC`,`ecodEstado`,`ecodCiudad`,`ecodCreacion`,`fhCreacion`,ecodEstatus)
values (tTiffv,tNombrev,tNombreCortov,tRFCv,ecodEstadov,ecodCiudadv,loginEcodUsuarios,NOW(),ecodEstatusv);
SELECT  LAST_INSERT_ID() AS Codigo;

ELSE

	
	SELECT ecodTif AS Codigo;

UPDATE cattiff SET ecodEstatus = ecodEstatusv, tTif = tTiffv, tNombre = tNombrev, tNombreCorto = tNombreCortov, tRFC = tRFCv, ecodEstado = ecodEstadov, ecodCiudad = ecodCiudadv,ecodEdicion=loginEcodUsuarios,fhEdicion=NOW()
WHERE
	ecodTif = ecodTiffv;
...
CREATE TABLE `cattiff` (
  ...
  `nCalle` varchar(10) DEFAULT NULL,
...
INSERT INTO `cattiff` (`ecodTif`, `tNombre`, `tNombreCorto`, `ecodCiudad`, `ecodEstado`, `nCalle`, `tcp`, `tTif`, `fhCreacion`, `ecodCreacion`, `tRFC`, `ecodEdicion`, `fhEdicion`, `ecodEliminacion`, `fhEliminacion`, `tMotivo`, `ecodEstatus`) VALUES
(6, 'LOGISTICA ALIMENTICIA ALCANTAR', NULL, 736, 15, NULL, NULL, 'TIF 653', '2022-11-25 08:52:54', 'Administrador1', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(7, 'CONGELADORA Y CONSERVADORES DEL PACIFICO', NULL, 1872, 25, NULL, NULL, 'TIF 486', '2022-11-25 08:54:54', 'Administrador1', NULL, NULL, NULL, NULL, NULL, NULL, 1),
(8, 'BASAL MONTERREY', NULL, 973, 19, NULL, NULL, 'TIF 325', '2022-11-25 08:55:54', 'Administrador1', NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
--
ALTER TABLE `cattiff`
  MODIFY `ecodTif` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
